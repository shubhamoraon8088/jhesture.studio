      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-32">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
            {/* Gmail */}
            <a
              href="mailto:shubhamoraon8088@gmail.com"
            ...
            >
              ...
              <span className="border-b border-white pb-1 group-hover:border-green-500">WhatsApp</span>
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-12 text-xs uppercase tracking-widest text-brand-muted font-sans">
          ...
          <p>© 2024 jhesture.studio. All Rights Reserved.</p>
