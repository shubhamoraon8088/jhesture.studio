    ...
    <footer id="contact" className="bg-brand-black pt-32 pb-12 px-6 md:px-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-32">
          <h2 className="text-6xl md:text-8xl lg:text-[10rem] font-serif tracking-tighter mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
            ...
            <a
              ...
              className="flex items-center gap-3 text-sm md:text-2xl font-sans hover:scale-105 transition-all duration-300 group"
            >
              ...
              <span className="border-b border-white pb-1 group-hover:border-red-500 truncate max-w-[200px] md:max-w-none">shubhamoraon8088@gmail.com</span>
            </a>
